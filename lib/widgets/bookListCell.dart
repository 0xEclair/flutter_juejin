...
import 'package:flutter_juejin/util/util.dart';
...
class BookListCell extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      padding:EdgeInsets.symmetric(horizontal: Util.setPercentage(0.03, context),vertical: 15.0),
      decoration: BoxDecoration(color: Colors.white,border: Border(bottom:BorderSide(color: accentColor,width:0.5))),
      child: Row(
