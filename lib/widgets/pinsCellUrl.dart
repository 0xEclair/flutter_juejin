    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          border:Border.all(color: Theme.of(context).accentColor,width: 10.0),
          ...
          children: <Widget>[
            Expanded(
              child: Column(
                ...
                children: <Widget>[
                  Text(
                    urlTitle,style: TextStyle(fontSize: 19.0,fontWeight: FontWeight.bold),
                    maxLines: 2,overflow: TextOverflow.ellipsis,
                  ),
                  Text(
                    url,style: TextStyle(fontSize: 15.0,color: Theme.of(context).accentColor),
